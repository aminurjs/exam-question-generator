...
const MathQuestionForm = ({ math, updateFields }) => {
  const [question, setQuestion] = useState(math.question);
  const [option_1, setOption_1] = useState(math.options?.option_1 || "");
  const [option_2, setOption_2] = useState(math.options?.option_2 || "");
  const [option_3, setOption_3] = useState(math.options?.option_3 || "");
